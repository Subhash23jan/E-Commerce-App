...
class _CartPageState extends State<CartPage> {
      ...
      httpErrorHandle(
        ...
        onSuccess: () async {
          ...
          for (dynamic item in list) {
            items.add(
                CartItem(item['quantity'], item['productId'], _user?.email));
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: ((cartItems.length != products.length) || !isLoaded)
          ? const Center(
                    ...
                    children: [
                      ...
                      Container(
                          ...
                          child: ElevatedButton(
                            ...
                            child: Text(" Buy now (${products.length}) items",
                                style: GoogleFonts.aBeeZee(
                                  color: Colors.black,
                                  fontSize: 17,
                      ...
                      SizedBox(
                        ...
                        child: ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            return cartProduct(
                                context, products[index], cartItems[index]);
                          },
                        ),
                      )
                    ],
