...
class _ProductWidgetState extends State<ProductWidget> {
  ...
  Widget build(BuildContext context) {
    return productModel==null?const Center(child: SizedBox()):InkWell(
      onTap: () => Navigator.push(context, MaterialPageRoute(builder: (context) => ProductPage(productId:productModel!.id),)),
      child: Container(
        width: 170,
        height: 240,
